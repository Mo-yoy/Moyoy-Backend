...
import com.moyoy.infra.database.follow.GithubFollowRelationSnapshot;
...
public class CacheConfig implements CachingConfigurer {
	...
	public RedisCacheManager cacheManager(RedisConnectionFactory connectionFactory) {
		...
		Jackson2JsonRedisSerializer<?> serializer = new Jackson2JsonRedisSerializer<>(objectMapper, GithubFollowRelationSnapshot.class);

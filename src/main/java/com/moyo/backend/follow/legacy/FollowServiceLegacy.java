...
public class FollowServiceLegacy {

    private final FollowRepositoryLegacy followRepositoryLegacy;
    ...
    public Set<GithubUserResponse> getFollowingOnlyList(GithubOAuth2User userPrincipal) {
        ...
        Set<GithubUserResponse> followingSet = new HashSet<>(followRepositoryLegacy.getFollowingList(getGithubOAuthAccessToken(userPrincipal)));
        Set<GithubUserResponse> followerSet = new HashSet<>(followRepositoryLegacy.getFollowerList(getGithubOAuthAccessToken(userPrincipal)));
    ...
    public void follow(String username, GithubOAuth2User userPrincipal) {
        ...
        if(followRepositoryLegacy.follow(username, getGithubOAuthAccessToken(userPrincipal)) == 204)
    ...
    public void unfollow(String username, GithubOAuth2User userPrincipal) {
        ...
        if(followRepositoryLegacy.unfollow(username, getGithubOAuthAccessToken(userPrincipal)) == 204)

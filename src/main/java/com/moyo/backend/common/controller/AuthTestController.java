...
public class AuthTestController {
    ...
    private void loggingPageable(Pageable pageable) {
        ...
        while (stk.hasMoreTokens()) {
            ...
            if(colon==-1) System.out.println("z");
            else if(colon==0) System.out.println("큰일남 :으로 시작함");
            else System.out.println(cur.substring(0,colon));
        }
    ...
    private void loggingLoginUserInfo(OAuth2AuthenticationToken authentication, GithubOAuth2User githubOAuth2User) {
        ...
        log.info("OAuth Access Info : type = {}, scope = {}, issuedAt = {}, expiresin = {}", accessToken.getTokenType(), accessToken.getScopes(), accessToken.getIssuedAt(), accessToken.getExpiresAt());

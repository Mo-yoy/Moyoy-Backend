...
public class GithubFollowServiceLegacy {
...
//
//        GithubFollowRelation githubFollowRelation = followRelationRepository.findByUserId(currentUserId).orElse(null);
//
//        // 캐시 미스
...
//                }
//
//                githubFollowRelation = GithubFollowRelation.builder()
...
//
//            try {
//                followRelationRepository.save(currentUserId, githubFollowRelation);
//            } catch (RedisConnectionFailureException ex) {
//                log.warn("Redis Server Down");
//            }
//            catch (QueryTimeoutException ex){
//                if(!redisHealthChecker.isHealthy()) log.error("Redis Server Down!");
//            }
//        }
//
//        // FollowRelation 도메인 객체의 비즈니스 로직 수행
//        List<GithubFollowUserInfoResponse> followUserList = githubFollowRelation.filterUsersByDetectType(request.getDetectType());
//
...
//        long minutes = Duration.between(githubFollowRelation.getCreatedAt(), LocalDateTime.now()).toMinutes()+1;
//
...
//            GithubFollowRelation currentUserGithubFollowRelation = getFollowRelationInCache(currentUserId);
//
//            if (currentUserGithubFollowRelation != null) {
//
//                currentUserGithubFollowRelation.addFollowing(targetUser);
//                followRelationRepository.update(currentUserId, currentUserGithubFollowRelation);
//            }
//
...
//                GithubFollowRelation targetUserGithubFollowRelation = getFollowRelationInCache(targetUser.getId());
//
//                if (targetUserGithubFollowRelation != null) {
//
...
//
//                    targetUserGithubFollowRelation.addFollower(currentUser);
//                    followRelationRepository.update(targetUser.getId(), targetUserGithubFollowRelation);
//                }
//            }
//
//        }
...
//            if (currentUserGithubFollowRelation != null) {
//
//                currentUserGithubFollowRelation.removeFollowing(targetUser.getId());
//                followRelationRepository.update(currentUserId, currentUserGithubFollowRelation);
//            }
//
...
//                if (targetUserGithubFollowRelation != null) {
//
//                    targetUserGithubFollowRelation.removeFollower(currentUserId);
//                    followRelationRepository.update(targetUser.getId(), targetUserGithubFollowRelation);
//                }
//            }
//        }

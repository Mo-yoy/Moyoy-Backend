...
public record GithubUserFollowStats(
	...
	public static GithubUserFollowStats from(GithubProfileResponse githubProfileResponse) {
		...
		int maxFollowingPageSize = githubProfileResponse.following() / GITHUB_MAX_QUERY_PAGING_SIZE + 1;
		int maxFollowerPageSize = githubProfileResponse.followers() / GITHUB_MAX_QUERY_PAGING_SIZE + 1;

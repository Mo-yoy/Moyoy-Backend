package com.moyoy.batch.domain.ranking.component.reader;
...
import com.moyoy.batch.domain.ranking.component.dto.GithubContributorDetails;
...
public class RankingBatchReader {
	...
	public List<GithubRepoDetails> fetchAllGithubRepoDetails(String accessToken) {
		...
		while (true) {
			...
			List<GithubRepoResponse> pagedRepos = githubRepoClient.fetchPagedRepos(affiliation, since,

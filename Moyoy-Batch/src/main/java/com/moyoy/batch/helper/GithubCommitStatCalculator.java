...
@Component
public class GithubCommitStatCalculator {

	public GithubCommitStats calculateCommitStats(List<GithubRepoCommitStats> userRepoContributorStats) {
		...
		for (GithubRepoCommitStats contributor : userRepoContributorStats) {

			for (GithubRepoCommitStats.Week week : contributor.weeks()) {
